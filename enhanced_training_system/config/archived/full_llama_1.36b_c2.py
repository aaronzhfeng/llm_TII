...
- Actual: 1.358B parameters (19L-18H-2304D-6144ff)
- Design: C-2 (minimal change) - classic 8/3 LLaMA FFN ratio
...
# === Model Dimensions (C-2: Minimal Change from Original) ===
n_layer = 19                # Number of transformer layers
...
d_ff = 6144                 # FFN dimension (24×256, classic 8/3 ratio)
